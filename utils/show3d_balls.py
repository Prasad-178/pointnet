...
# dllpath = os.path.dirname(os.path.abspath(__file__)) + os.path.sep
# print(dllpath)
# dll = np.ctypeslib.load_library('render_balls_so', dllpath)

# commands to make the dll file from the cpp file:
